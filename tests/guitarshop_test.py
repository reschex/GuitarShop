...
class TestGuitarShop():
    ...
    # Then a temporary hold for the sale quantity is placed on that product’s stock
    ...
    # And a new item is added to the order’s items list with that product and sale quantity
